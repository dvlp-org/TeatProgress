...
public class Test extends View {
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        int color1 = a.getColor(R.styleable.Test_ColorArcProgressBar_front_color1, Color.GREEN);
        int color2 = a.getColor(R.styleable.Test_ColorArcProgressBar_front_color2, color1);
        int color3 = a.getColor(R.styleable.Test_ColorArcProgressBar_front_color3, color1);
        colors = new int[]{color1, color2, color3, color3};

        sweepAngle = a.getInteger(R.styleable.Test_ColorArcProgressBar_total_engle, 270);
        bgArcWidth = a.getDimension(R.styleable.Test_ColorArcProgressBar_back_width, dipToPx(2));
        progressWidth = a.getDimension(R.styleable.Test_ColorArcProgressBar_front_width, dipToPx(10));
        isNeedTitle = a.getBoolean(R.styleable.Test_ColorArcProgressBar_is_need_title, false);
        isNeedContent = a.getBoolean(R.styleable.Test_ColorArcProgressBar_is_need_content, false);
        isNeedUnit = a.getBoolean(R.styleable.Test_ColorArcProgressBar_is_need_unit, false);
        isNeedDial = a.getBoolean(R.styleable.Test_ColorArcProgressBar_is_need_dial, false);
        hintString = a.getString(R.styleable.Test_ColorArcProgressBar_string_unit);
        titleString = a.getString(R.styleable.Test_ColorArcProgressBar_string_title);
        curValues = a.getFloat(R.styleable.Test_ColorArcProgressBar_current_value, 0);
        maxValues = a.getFloat(R.styleable.Test_ColorArcProgressBar_max_value, 60);
